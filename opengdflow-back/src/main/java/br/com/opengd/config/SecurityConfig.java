        ...
        http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(
                                ...
                                "/auth/forgot-password", // Rota de recuperação de senha
                                "/auth/reset-password" // Rota de redefinição de senha
                        ).permitAll()
                        .anyRequest().authenticated())
                //TODO Pratica usada somente local, mas em produção não desabilitar o csrf
                .csrf(csrf -> csrf.disable())
                //TODO Pratica usada somente local, mas em produção não desabilitar o cors
