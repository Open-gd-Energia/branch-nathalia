...
import { DadosCalculoReceber } from "./receber/dados-calculo";
import { RegrasCobranca } from "./receber/regras-cobranca";
import type { ZodCobrancaFormData } from "./zod-schemas";

export const CobrancaReceberForm = () => {
	...
	return (
		<>
			...
			<section id="cobrancas-vinculadas" className="flex flex-col gap-4">
				<h3 className="font-semibold leading-7 mb-1">
					2. Regras de Cobrança Vinculadas
				</h3>
				<RegrasCobranca />
			</section>
			...
			<section id="itens-eventuais" className="flex flex-col gap-4">
				<h3 className="font-semibold leading-7 mb-1">3. Itens Eventuais</h3>
				<DiscountAddItems />
			</section>
			...
			<section id="dados-calculo" className="flex flex-col gap-4">
				<h3 className="font-semibold leading-7 mb-1">4. Dados de Cálculo</h3>
				<DadosCalculoReceber />
			</section>
			...
			<section id="observacoes" className="flex flex-col gap-4">
				<h3 className="font-semibold leading-7 mb-1">5. Observações</h3>
